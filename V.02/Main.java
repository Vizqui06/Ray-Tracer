...
public class Main {
    public static void main(String[] args) {
        ...
        scene.addObject(new TriangleIntersection(new Vector3D(0, 0.5, 0), new Vector3D(-0.3, -0.2, 0),new Vector3D(0.3, -0.2, 0),
        new Vector3D(0, 0, 0), Color.CYAN));
        ...
        raytracer.render("Renders/Ray-Tracer_V02.png");
    }
}
