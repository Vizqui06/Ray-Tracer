...
public class RenderEmpire {
        ...
        public static void renderEmpire(String[] args) {
                Camera camera = new Camera(new Vector3D(
                        ...
                        -2.5 // X rotation (negative values to look down)
                ); 
                ...
                Model3D modelCup = new Model3D(new Vector3D(0.3, -0.075, 2.8), 3.0, 90.0, -90.0, 180.0, defaultCup, 0.0, 0.0, 0.0);
                
                Model3D modelSamurai = new Model3D(new Vector3D(-1.2, 0.143, -2.0), 0.00008, 0.0, 30.0, 0.0, defaultSamurai, 0.0, 0.0, 0.0);
                Model3D modelScroll = new Model3D(new Vector3D(-0.22, -0.11, 2.8), 0.003, 32.0, 184.0, -95.0, defaultScroll, 0.0, 0.0, 0.0);
                Model3D modelTable = new Model3D(new Vector3D(0.0, -0.50, 2.8), 0.07, 1.0, 0.0, 0.0, defaultTable, 0.0, 0.0, 0.0);
                Model3D modelVase = new Model3D(new Vector3D(1.3, -0.313, -1.8), 0.00187, -1.0, -22.0, -1.0, defaultVase, 0.0, 0.0, 0.0);
                Model3D modelPot = new Model3D(new Vector3D(0.7, 0.35, 2.8), 0.40, 0.0, 180.0, 45.0, defaultPot, 0.0, 0.0, 0.0);
                ...
                scene.addLight(new LightPhong(new Vector3D(1.0, 0.8, -1.0), Color.WHITE, 0.7, 20.0));
                scene.addLight(new LightPoint(null, Color.WHITE, 1.5, new Vector3D(-0.1, 0.4, 2.8)));
                ...
                /* 
                scene.addLight(new LightPhong(new Vector3D(0.0, 1.0, -1.0), Color.WHITE, 0.6, 20.0));
                scene.addLight(new LightLambertian(new Vector3D(0.0, 2.0, -3.0), Color.WHITE, 0.8));
                scene.addLight(new LightPoint(null, Color.WHITE, 1.5, new Vector3D(-1.0, 0.8, -3.0)));
                scene.addLight(new LightPoint(null, Color.WHITE, 1.5, new Vector3D(0.0, 0.5, 0.0)));
                scene.addLight(new LightPoint(null, Color.WHITE, 1.5, new Vector3D(1.0, 0.5, 5.0)));
                */
